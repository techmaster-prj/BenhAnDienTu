...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        passwarning = getResources().getString(R.string.passwarning);
        emailwarning = getResources().getString(R.string.emailwarning);
        allwarning = getResources().getString(R.string.allwarning);
        ...
        loaduser = getResources().getString(R.string.loaduser);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((!inputEmail.getText().toString().equals("")) && (!inputPassword.getText().toString().equals(""))) {
                    ...
                    Toast.makeText(getApplicationContext(), passwarning, Toast.LENGTH_SHORT).show();
                } else if ((!inputPassword.getText().toString().equals(""))) {
                    Toast.makeText(getApplicationContext(), emailwarning, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), allwarning, Toast.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    private class NetCheck extends AsyncTask<String, String, Boolean> {
        ...
        protected void onPostExecute(Boolean th) {
            ...
            if (th == true) {
                ...
                nDialog.dismiss();
                loginErrorMsg.setText(networkwarning);
            }
        }
    }
                ...
                if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if (Integer.parseInt(res) == 1) {
                        ...
                        db.addUser(json_user.getString(KEY_FIRSTNAME), json_user.getString(KEY_LASTNAME),
                                ...
                                json_user.getString(KEY_PHONENUMBER), json_user.getString(KEY_BIRTHYEAR),json_user.getString(KEY_CREATED_AT));
                        /**
