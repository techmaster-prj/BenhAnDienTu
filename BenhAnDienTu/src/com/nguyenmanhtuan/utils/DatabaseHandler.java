...
public class DatabaseHandler extends SQLiteOpenHelper {
     ...
     * */
    public void addUser(String fname, String lname, String email, String uname, String uid, String address, String phonenumber, String birthyear, String created_at) {
        ...
        values.put(KEY_BIRTHYEAR, birthyear);// Email
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        if(cursor.getCount() > 0){
            ...
            user.put("phonenumber", cursor.getString(7));
            user.put("birthyear", cursor.getString(8));           
